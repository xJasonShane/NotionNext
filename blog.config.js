...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '176d6b4eaa73801bbebbf14e0d61181a,en:176d6b4eaa73801bbebbf14e0d61181a',
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2025, // e.g 如果留空，将使用当前年份。
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'JasonShane', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.xshan.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'JasonShane, 博客, blog', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个普通人, Hi，我是一个打工人,Hi，我是一个精益人,欢迎来到我的博客🎉',
