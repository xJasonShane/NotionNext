const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-01-09', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.xshan.top' },
    { title: '访问我的Github主页', url: 'https://github.com/xJasonShane' }
  ],
  ...
  // 英雄区(首页顶部大卡)
  HEO_HERO_TITLE_1: '感知世界',
  HEO_HERO_TITLE_2: '汇聚思想',
